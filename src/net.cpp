...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Rothscoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][3] = {
    {"rtc-api.com", "45.76.24.19"},
	{"rtcchain.net", "45.77.2.238"},//52.4.67.185
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][3] = {
    {"rothscoin.com", "ec2-52-205-49-51.compute-1.amazonaws.com"},   
	{NULL, NULL},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Rothscoin is probably already running."), addrBind.ToString().c_str());
        else
