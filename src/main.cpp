...
#if defined(NDEBUG)
# error "Rothscoin cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0x7a881ddb6bfbcec3c6c81c4bf670eda29cf8e0df73ace761d4ebf21945153dbc");
//0x6fc554229b910a11ac603166c88b2d7c27bfd039bd8bb11dc32561614abca13b
//0x05919b92e929146b2a0e13f0ff0778011d03849a19a329d9e0560059d3049021
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Rothscoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Rothscoin Signed Message:\n";
...
{
    // Rothscoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
	...
	{
		int64 nextReward = startReward/(nHeight/1050000 + 1);
		if(nextReward>1)
		{
    ...
    //nSubsidy >>= (nHeight / 840000); // Rothscoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 24 * 60 * 60; // Rothscoin: 1 days
static const int64 nTargetSpacing = 2 * 60; // Rothscoin: 2 minutes.
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Rothscoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Rothscoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x7a881ddb6bfbcec3c6c81c4bf670eda29cf8e0df73ace761d4ebf21945153dbc");
		//0x6fc554229b910a11ac603166c88b2d7c27bfd039bd8bb11dc32561614abca13b
		//0x05919b92e929146b2a0e13f0ff0778011d03849a19a329d9e0560059d3049021
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "01/Jan/2018 Police: 1 dead after car rams Jerusalem train platform in terror attack";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1525917784; //1525824000; //1524501685;
        block.nBits    = 0x1e0ffff0;//0x1d00ffff
        block.nNonce   = 592629; //95611; //2167216;
        ...
        assert(block.hashMerkleRoot == uint256("0x50e7127fd7981c06ca4439f427c6e5a84cdc12794dfdd7b706d454424e2a1bb7"));
		//0x50e7127fd7981c06ca4439f427c6e5a84cdc12794dfdd7b706d454424e2a1bb7
...
unsigned char pchMessageStart[4] = { 0xc3, 0xd2, 0xd1, 0xbd }; // Rothscoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("RothscoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("RothscoinMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static RothscoinMiner(CWallet *pwallet)
{
    printf("RothscoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("rothscoin-miner");
    ...
    try { loop {
        ...
        printf("Running RothscoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("RothscoinMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&RothscoinMiner, pwallet));
}
